...
editor = os.getenv("geany") or "nano"
...
-----------------------------------------------------------------------------------------------------
    ...
    mydownload = awful.widget.launcher({ image = "/home/phil/.config/awesome/download.png", command = "su-to-root -X -c mx-packageinstaller" })
    local mytext = wibox.widget {
    markup = "<span foreground='#00ff00'> Ram: </span>",
    widget = wibox.widget.textbox,
    }
	local mytext_date = wibox.widget {
    markup = "<span foreground='#00ff00'> Date:</span>",
    widget = wibox.widget.textbox,
    }
...
--------------------------------------------------------------------------------------- MY APPS ---------------------------------------------------------------------------
    ...
    awful.spawn('dmenu_run -fn "Noto Sans Regular-16" -sb "#990000" -sf "#FFFF66" -p "Run: "') end,
