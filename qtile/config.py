        ...
        top=bar.Bar(
            [
                ...
                widget.TextBox(
                    ...
                    #"#006666",
                    foreground='#ff3399',
                    mouse_callbacks={'Button3': lambda: qtile.cmd_spawn("jgmenu_run"), 'Button1': lambda: qtile.cmd_spawn("/home/phil/.config/rofi/launchers/colorful/launcher.sh")},
                    ),
                #widget.TextBox(
                #    text='\ue0be',
                #    font="Inconsolata for powerline",
               ...
               # ),
                ...
                widget.GroupBox(
                    ...
                    this_current_screen_border="#cc99ff",
                    #colors[7],
